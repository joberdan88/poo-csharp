// Aplicação de música - Screen Sound
...
void MediaDaBanda()
{
    ...
    Console.Write("Qual banda você deseja consultar a media das notas? ");
    ...
    if (bandasRegistradas.ContainsKey(banda))
    {
        ...
        if (notas.Count > 0)
        {
            ...
            Console.WriteLine($"\nA média de notas da banda {banda} é {media:F2}");
        }
        else
        {
            Console.WriteLine($"\nA banda {banda} ainda não possui notas.");
        }
    }
    else
    {
